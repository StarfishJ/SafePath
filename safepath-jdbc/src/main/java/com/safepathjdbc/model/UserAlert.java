...
public class UserAlert {
    // Align to Spring entity (user_alerts table)
    ...
    public String getCrimeTypeFilter() { return crimeTypeFilter; }
    public void setCrimeTypeFilter(String crimeTypeFilter) { this.crimeTypeFilter = crimeTypeFilter; }
